...
WebUI.sendKeys(findTestObject('Object Repository/FormSubmit/Input_Birthday'), '1996 January 24' + Keys.ENTER)
...
// Input Address
WebUI.setText(findTestObject('Object Repository/FormSubmit/Textarea_Address'), 'Jalan Mekar Sari no. 15')
