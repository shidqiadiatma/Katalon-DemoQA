...
WebUI.sendKeys(findTestObject('Object Repository/FormSubmit/Input_Birthday'), '2050 January 20' + Keys.ENTER)
...
// Input Address
WebUI.setText(findTestObject('Object Repository/FormSubmit/Textarea_Address'), 'Jalan Mekar Sari No. 11')
