...
// Input Address
WebUI.setText(findTestObject('Object Repository/FormSubmit/Textarea_Address'), 'Jl. Malaka Sari No 77')
...
WebUI.verifyElementPresent(findTestObject('FormSubmit/modal_Success'), 5)
